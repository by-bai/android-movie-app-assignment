...
public class MovieDetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getMovieDetails() {
        ...
        Call<MovieDetails> getMovies = ApiClient.movieApi().getMovieDetails(328111, "328c283cd27bd1877d9080ccb1604c91");
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.back_button:
                startActivity(new Intent(getApplicationContext(), DiscoverMoviesActivity.class));
                break;
